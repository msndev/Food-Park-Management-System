        ...
        success: data => {
            ...
            Object.keys(data).forEach(key=>{
                ...
                if(data[key][data[key].length-1].served=='false'){
                    pageContent += `<div class="card mb-auto mx-auto my-3 col-md-11"><div class="card-body"><h5 class="card-title">${data[key][0].timeOfOrder}</h5><p class="card-text"><span class="cost">`;
